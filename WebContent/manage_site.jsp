      ...
      <div class="col-md-6 col-sm-6">
        <div class="add-blk">
      	...
      	<!-- Here Data is handle controller and saving in database -->
            <form action="controller/Labourbranchdatasave.jsp">
              <div class="row">
                <div class="col-md-6 col-sm-6">
                <input type="hidden" class="form-control" id="branchtype" name="branchtype" value="site">
            ...
            <div class="table-responsive">
              <table id="example2" class="table table-bordered table-hover tbl">
                ...
                <tbody>
                 ...
                 <td><input type="submit" value="delete" onClick="deleteRecord('<%=branchDetail.getBranchName()%>')" ></td>
                 </tr>
                 <%} %>
                 <script>
        function deleteRecord(id){
    	alert(id);
    	window.open("controller/DeleteBranchDetail.jsp?id="+id,"_self");
