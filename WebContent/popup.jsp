...
System.out.println("edit"+empid);
if(empid!=null)
{
    sess.setAttribute("edit", empid);
    sess.setAttribute("editbranch", branch);
}   
    String id=(String)sess.getAttribute("edit");
    String editbranch=(String)sess.getAttribute("editbranch");
...
<input type="submit" value="Upload File" />
          ...
          <div class="middle-bg">
            ...
            <form action="controller/Edit.jsp">
                        ...
                        <%
	                       ...
	                       employeeData=DataRetrieve.getEmployeeProfileEdit(id,editbranch);
                        ...
                        %>
							...
							<input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<%=empRegistration.getEmail()%>">
							</div>
							</div>
							...
							<input type="text" class="form-control" id="qualification" name="qualification" value="<%=empRegistration.getQualification()%>">
							</div>
							</div>
							...
							<input type="text" class="form-control" id="designation" name="designation" value="<%=empRegistration.getDesignation()%>">
							</div>
							</div>
