...
<!-- Main content -->
			    ...
			    <div class="col-md-4 col-sm-4">
					...
					<div class="col-md-4 col-sm-4">
						<div class="form-group" >
                            ...
                            batchData=DataRetrieve.getBranchDetails();
                ...
                <div class="row">
					...
					<div class="col-md-4 col-sm-4">
						<div class="form-group" >
                            ...
                            batchDataa=DataRetrieve.getBranchDetails();
  ...
  <script type="text/javascript">
   ...
   function changeEmployee() {
    ...
    window.open("EmployeeAutoSalaryGeneration.jsp?branch="+branch+ "&type=B","_self");
   }
  ...
  <script type="text/javascript">
   ...
   function changeIndEmployee() {
    ...
    window.open("EmployeeAutoSalaryGeneration.jsp?id="+id+ "&type=I","_self");
   }
			...
			<div class="row">
				...
				<div class="add-blk">
				<div class="panel-heading new-bg"><h3>Employee Salary Details</h3></div>
              ...
              <tbody>
                ...
                String salreporttype=request.getParameter("type");
      			...
      			String salend=SMSSending.getDate();
      			String[] part=salend.split("-");
      			String salstart=part[0]+"-"+part[1]+"-"+1;
      			System.out.println("salstart"+salstart);
      			if( salreporttype != null && salreporttype.equals(s1))
      			{System.out.println("ddddd");
      					
      					list=DataRetrieve.indivisualEmployeeSalary(id,salstart,salend,branch);
      				 
      			}	
      			
      		  else if(salreporttype != null && salreporttype.equals(s4))
      			{        System.out.println("branchcame");
      					 list= DataRetrieve.branchEmployeeSalary(branchsal,salstart,salend);
