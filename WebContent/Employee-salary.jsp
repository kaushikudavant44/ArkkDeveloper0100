    ...
    <div class="row">
      <div class="col-md-6 col-sm-6">
        <div class="add-blk">
          ...
          <form action="controller/Salary.jsp" >
          <div class="middle-bg">
                ...
                <div class="col-md-4 col-sm-4">
                  <div class="form-group">
                    ...
                    <select id="country" name="report" class="form-control">
                      <option value="B" id="text">Branchwise Salary</option>
            ...
            <div class="table-responsive">
              ...
              <tbody>
                 <tr>
      			...
      			String indbranch=(String)session.getAttribute("indbranch");
      			...
      			if( salreporttype != null && salreporttype.equals(s1))
      			{
      					...
      					list=DataRetrieve.indivisualEmployeeSalary(emp_id,salstart,salend,indbranch);
      				 
      			}	
      			
      		  else if(salreporttype != null && salreporttype.equals(s4))
      			{ 
      					 list= DataRetrieve.branchEmployeeSalary(salbranch,salstart,salend);
